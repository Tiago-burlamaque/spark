...
describe("GET /post/buscar", () => {
    ...
    it("Deve retornar erro 404 se não tiver nenhum post, caso contrário, retorna 200 se tiver ao menos um post.", async () => {
    ...
    it("Deve retornar 200 quando fizer um get Por Id, caso contrário, retorna 404.", async () => {
        const res = await request(app)
            .get('/post/buscar/1')
            .set("Authorization", `Bearer ${token}`)
